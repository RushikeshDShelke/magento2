...
//        }
        ...
        try 
        {
            ...
            {
                // if before addProduct method throws the exception then below code will execute
                ...
                if ($cartItemsCounts > 0) // if cart has items
                {
                    ...
                    {
                        $cartItemsArr['product_id'] = $item->getId();
                        $cartItemsArr['product_name'] = $item->getName();
                        $cartItemsArr['product_type'] = $item->getProductType();
                    }
                    ...
                    if (in_array("amgiftcard", $finalCartItemArr))
                    {
                        ...
                        {   
                            ...
                            $htmlPopup = $this->_ajaxcartData->restrictProductCartTypeNotMatchHtml($product); // set template to show the error message
                    ...
                    else // check if amgiftcard is NOT exist in cart
                    {
                        ...
                        if ($currentProType == "amgiftcard") 
                        {
                            ...
                            // set template to show the error message
                            $htmlPopup = $this->_ajaxcartData->restrictProductCartTypeMatchHtml($product);
