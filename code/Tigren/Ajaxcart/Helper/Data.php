...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    // if cart has NOT Amasty Giftcard
    // SET layout if the current product IS amgiftcard
    public function restrictProductCartTypeMatchHtml($product)
    {
        $layout = $this->_layoutFactory->create();
        $layout->getUpdate()->load('ajaxcart_restrict_product_cart_type_match');
        $layout->generateXml();
        $layout->generateElements();
    ...
    // if cart has Amasty Giftcard
    // SET layout if the current product IS NOT amgiftcard
    public function restrictProductCartTypeNotMatchHtml($product)
    {
        $layout = $this->_layoutFactory->create();
        $layout->getUpdate()->load('ajaxcart_restrict_product_cart_type_not_match');
        $layout->generateXml();
        $layout->generateElements();
