...
class CategoriesRepository implements CategoryRepositoryInterface
{
    ...
    public function getList(SearchCriteriaInterface $searchCriteria)
    {
        ...
        foreach ($categoriesCollection->getItems() as $categories) {
            $categories[] = $this->getById($categories->getCategoryId());
        }
    ...
    public function getChildrenCategories($parentId)
    {
        ...
        $collection->setPageSize($this->settings->getCategoriesLimit());
